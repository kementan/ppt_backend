...
type (
	...
	usecase struct {
		repo LandStatusRepository
	}
)

func NewUsecase(repo LandStatusRepository) LandStatusUsecase {
	return &usecase{
		repo: repo,
	}
}
...
func (uc *usecase) Create(c *gin.Context) {
	var req LandStatusCreateRequest
...
func (uc *usecase) Update(c *gin.Context) {
	var req LandStatusUpdateRequest
