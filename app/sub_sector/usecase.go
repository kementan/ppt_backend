...
type (
	...
	usecase struct {
		repo SubSectorRepository
	}
)

func NewUsecase(repo SubSectorRepository) SubSectorUsecase {
	return &usecase{
		repo: repo,
	}
}
...
func (uc *usecase) Create(c *gin.Context) {
	var req SubSectorCreateRequest
...
func (uc *usecase) Update(c *gin.Context) {
	var req SubSectorUpdateRequest
