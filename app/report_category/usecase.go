...
type (
	ReportCategoryUsecase interface {
	...
	usecase struct {
		repo ReportCategoryRepository
	}
)

func NewUsecase(repo ReportCategoryRepository) ReportCategoryUsecase {
	return &usecase{
		repo: repo,
	}
}
...
func (uc *usecase) Create(c *gin.Context) {
	var req ReportCategoryCreateRequest
...
func (uc *usecase) Update(c *gin.Context) {
	var req ReportCategoryUpdateRequest
