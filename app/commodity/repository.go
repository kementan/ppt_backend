...
type (
	CommodityRepository interface {
		GetDataBy(c context.Context, field string, value string) (CommodityResponse, error)
		GetTable(c context.Context, arg util.DataFilter) ([]CommodityResponse, error)
		CountRecords(c context.Context, arg util.DataFilter) (int, error)
		Create(c context.Context, arg CommodityCreate) (CommodityResponse, error)
		Read(c context.Context) ([]CommodityResponse, error)
		Update(c context.Context, id string, arg CommodityUpdate) (CommodityResponse, error)
...
func NewRepository(db *sql.DB) CommodityRepository {
	return &repository{
		db: db,
	}
}

func (q *repository) GetDataBy(c context.Context, field string, value string) (CommodityResponse, error) {
	var r CommodityResponse
	var enc_id string
...
func (q *repository) GetTable(c context.Context, arg util.DataFilter) ([]CommodityResponse, error) {
	offset := (arg.Page - 1) * arg.PageSize
	items := []CommodityResponse{}
...
func (q *repository) Create(c context.Context, arg CommodityCreate) (CommodityResponse, error) {
	var r CommodityResponse
	var enc_id string
...
func (q *repository) Read(c context.Context) ([]CommodityResponse, error) {
	query := `
	SELECT id, name, description, created_at, updated_at
...
func (q *repository) Update(c context.Context, id string, arg CommodityUpdate) (CommodityResponse, error) {
	var r CommodityResponse
